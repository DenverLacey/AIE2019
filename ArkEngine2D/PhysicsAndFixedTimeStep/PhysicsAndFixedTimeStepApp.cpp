...
bool PhysicsAndFixedTimeStepApp::startup() {
	...
	auto* ball = new Sphere(glm::vec2(-40, -10), glm::vec2(0, 0), 3.f, 9.f, glm::vec4(0, 0, 1, 1));
	auto* ball1 = new Sphere(glm::vec2(40, 10), glm::vec2(0, 0), 1.f, 3.f, glm::vec4(1, 1, 1, 1));
	...
	m_rocket = new Sphere(glm::vec2(40, -30), glm::vec2(0, 0), 5.f, 6.f, glm::vec4(1.f, 1.f, 1.f, .5f));
